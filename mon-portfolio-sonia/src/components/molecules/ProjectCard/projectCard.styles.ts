...
export const githubButtonStyle =
  "p-2 rounded-full bg-gradient-to-r from-[#915EFF] to-[#00c8ff] hover:scale-110";

export const titleStyle = "text-white leading-snug";

export const descriptionStyle = "text-white/80 mt-2 text-sm line-clamp-3";

export const tagsContainerStyle = "mt-3 flex flex-wrap gap-2";
